        ...
        <div class="bar-obtions d-flex align-items-end justify-content-between flex-wrap gap-3 mb-4">
            <div class="row flex-fill g-3">
                <div class="d-flex align-items-center gap-2 mt-2">
                    <a href="{{ route('dashboard.students.index') }}" class="main-btn btn-sm bg-primary">الكل :
                    ...
                    @can('create_students')
                        <a href="{{ route('dashboard.students.create') }}" class="main-btn btn-purple btn btn-sm"><i
                                class="fas fa-plus"></i> اضافة طالب جديد
                        </a>
                    @endcan
                </div>
            </div>
